...
-	RPA using UiPath for Testing: Innovated UiPath-RPA solutions to enhance Tableau testing for 3 test cases, reducing manual testing efforts by 70% and improving data quality assurance.


**Intern- Data Science @ Samsons Hardware (_Jan 2021 - May 2021_)**
- Time Series Analysis for Smart supply chain management: Created a machine learning model and performed EDA, and feature engineering to predict hardware machinery demand, reducing prediction error by 25% and optimizing supply chain operations
